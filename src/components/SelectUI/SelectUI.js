        ...
        <div className=' w-screen flex justify-center'>
            <div className=' w-3/4'>
                <div className=' relative cursor-pointer '>
                    <div className={` ${show ? ' border-2 border-blue-500' : err? ' border border-red-400': 'border-gray-200 border'} py-1 px-1 flex flex-row justify-between`} onClick={() => setShow(true)}><p>{value}</p><div><button>{show ? <ExpandLessIcon/> : <ExpandMoreIcon/>} </button></div></div>
